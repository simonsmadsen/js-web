...
export async function getFacebookFields(accessToken, fields = 'name,id') {
...
export async function getFacebookImage(accessToken, path, type = 'normal') {
...
export async function getGoogleImage(id, path) {
...
export async function getTwitterImage(screenName, path) {
  return downloadImage(
    `https://twitter.com/${screenName}/profile_image?size=normal`,
    path
  )
}
